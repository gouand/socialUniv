...
<div class="row">
        ...
        <div class="col-6">
            <section class="new-post pt-0 w-100">
                <div class="pt-0">
                    ...
                    <form action="{{ route('group.createPost', 1) }}"  enctype="multipart/form-data" method="post">
                            ...
                            <article class="mt-3">
                                ...
                                <div class="post" data-postid="{{ $post->id }}">
                                    ...
                                    <div class="interaction">
                                       ...
                                       @if(Auth::user() == $post->user or !is_null(\App\Group::find($group->id)))
                                        ...
                                        @endif;
                                        <form id="delete-post-{{$post->id}}-form" action="{{ route('deletePost', ['id' => $post->id, 'group_id' => $group->id]) }}" method="POST" style="display: none;">
                                            @csrf
                                        </form>
                                    </div>
                                </div>
        ...
        <div class="col-3">
            <img width="100%" src="{{ Storage::url($group->logotype) }}" class="rounded float-left" alt="">
...
{{--                </div>--}}
                ...
                <a class="btn btn-outline-primary" href="#" role="button">Подписаться</a>
            </div>
